...
public partial class JsonEditor : Window
{
    ...
    #region Main Logic
    private void GameIdTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.GameName = GameIdTextBox.Text;

    private void VersionTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.GameVersion = VersionTextBox.Text;

    private void FileLocationTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.MainFile = FileLocationTextBox.Text;

    private void BrowseForHtmlFileButton_Click(object sender, RoutedEventArgs e)
    {
        VistaOpenFileDialog htmlFilePicker =
            new()
            {
    ...
    private void EnableNodeJSCheckBox_CheckChanged(object sender, RoutedEventArgs e) => ProjectMetadata.UseNodeJs = EnableNodeJSCheckBox.IsChecked == true;

    private void ChromeFlagsTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.ChromiumFlags = ChromeFlagsTextBox.Text;

    private void JsFlagsTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.JsFlags = JsFlagsTextBox.Text;

    private void GameNameTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.GameTitle = GameNameTextBox.Text;

    private void IconLocationTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.WindowProperties.WindowIcon = IconLocationTextBox.Text;
    ...
    private void WindowTitleTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.WindowProperties.WindowTitle = WindowTitleTextBox.Text;

    private void WindowIdTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e) => ProjectMetadata.WindowProperties.WindowId = WindowIdTextBox.Text;

    private void ResizableWindowCheckBox_CheckChanged(object sender, RoutedEventArgs e) => ProjectMetadata.WindowProperties.IsResizable = ResizableWindowCheckBox.IsChecked == true;
    ...
    private void WindowLocationList_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e) => ProjectMetadata.WindowProperties.ScreenPosition = WindowLocationList.SelectedIndex switch
    {
        2 => "mouse",
        1 => "center",
        _ => "none",
    ...
    private void HeightNumber_ValueChanged(object sender, RoutedPropertyChangedEventArgs<uint> e) => ProjectMetadata.WindowProperties.WindowHeight = HeightNumber.Value;

    private void MinimumHeightNumber_ValueChanged(object sender, RoutedPropertyChangedEventArgs<uint> e) => ProjectMetadata.WindowProperties.MinimumHeight = MinimumHeightNumber.Value;

    private void WidthNumber_ValueChanged(object sender, RoutedPropertyChangedEventArgs<uint> e) => ProjectMetadata.WindowProperties.WindowWidth = WidthNumber.Value;

    private void MinimumWidthNumber_ValueChanged(object sender, RoutedPropertyChangedEventArgs<uint> e) => ProjectMetadata.WindowProperties.MinimumWidth = MinimumWidthNumber.Value;
    #endregion
